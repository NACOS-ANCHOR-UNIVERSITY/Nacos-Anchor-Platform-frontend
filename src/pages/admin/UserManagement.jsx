...
import Logo from '../../assets/images/nacos_logo.png'
            ...
            `}> 
                <div className="mb-8 flex items-center gap-2 px-6">
                    ...
                    <div className='flex flex-col'>
                        ...
                        <span className="font-medium text-xs text-[#64748B]">Admin Console</span>
                    </div>
                ...
                <nav className='px-6 mb-auto overflow-y-auto'>
                    <ul className="flex flex-col gap-6 font-medium text-[14px] text-[#475569]">
                        <li className='flex items-center gap-2'>
                            <img src={Dashboard} alt="Dashboard" className="w-5 h-5 mr-2 inline" /> Dashboard
                        </li>
                        <li className='flex items-center gap-2 bg-[#138601] rounded-xl text-white px-4 py-2.5'>
                            <img src={UserManage} alt="User Management" className="w-5 h-5 mr-2 inline" /> User Management
                        </li>
                        <li className='flex items-center gap-2'>
                            <img src={Content} alt="Content Moderation" className="w-5 h-5 mr-2 inline" /> Content Moderation
                        </li>
                        <li className='flex items-center gap-2'>
                            <img src={Payments} alt="Payments" className="w-5 h-5 mr-2 inline" /> Payments
                        </li>

                        <li className="border-t border-[#E2E8F0] text-xs my-3">MODULES</li>

                        <li className='flex items-center gap-2'>
                            <img src={Events} alt="Events & Polls" className="w-5 h-5 mr-2 inline" /> Events & Polls
                        </li>
                        <li className='flex items-center gap-2'>
                            <img src={Siwes} alt="SIWES Board" className="w-5 h-5 mr-2 inline" /> SIWES Board
                        </li>
                        <li className='flex items-center gap-2'>
                            <img src={Voting} alt="Voting System" className="w-5 h-5 mr-2 inline" /> Voting System
                        </li>
                    </ul>
                </nav>
                <div className="border-t border-[#E2E8F0] py-6 flex-col pl-6 flex items-start gap-2 bg-white">
                    <button className="text-red-600 cursor-pointer font-medium text-[14px] flex items-center gap-2">
                        <img src={Logout} alt="Logout" className="w-5 h-5 mr-2 inline" /> Logout
                    </button>
                </div>
            </aside>
            ...
            <div className="w-full min-[1200px]:w-[82%] bg-[#F8FAFC]">
                <header className='w-full py-3.5 bg-white border-b border-[#E2E8F0] px-6 flex items-center justify-between sticky top-0 z-30'>
                    <div className="flex items-center gap-4">
                        ...
                        <h2 className='font-medium text-[14px] text-[#1E293B]'>User Management</h2>
                    </div>
                    <div className='flex justify-center'>
                        <input type="search" placeholder='Search...' className='hidden md:block outline-0 bg-[#F1F5F9] rounded-full py-2.25 px-6' />
                ...
                {/* main content */}
                <main className='w-full px-4 md:px-15 py-5 h-[calc(100vh-80px)] overflow-y-auto'>{children}</main>
            </div>
        </div>
    )
}
...
// user data
const initialUsers = [
    { id: 1, name: "Adebayo John", email: "adebayo.j@student.edu", matric: "AUL/CMP/22/080", level: "400L", role: "Class Rep", status: "Active", avatarColor: "bg-blue-100 text-blue-600", selected: false },
    { id: 2, name: "Chioma Nwechuku", email: "chioma.n@student.edu", matric: "AUL/CMP/22/081", level: "300L", role: "Student", status: "Active", avatarColor: "bg-pink-100 text-pink-600", selected: false },
    { id: 3, name: "Emmanuel Ojo", email: "emmanuel.o@student.edu", matric: "AUL/CMP/22/082", level: "200L", role: "Student", status: "Pending", avatarColor: "bg-yellow-100 text-yellow-600", selected: false },
    { id: 4, name: "Fatima Yusuf", email: "fatima.y@student.edu", matric: "AUL/CMP/22/083", level: "100L", role: "Student", status: "Active", avatarColor: "bg-green-100 text-green-600", selected: false },
    { id: 5, name: "Daniel Peters", email: "daniel.p@student.edu", matric: "AUL/CMP/22/084", level: "400L", role: "Student", status: "Active", avatarColor: "bg-purple-100 text-purple-600", selected: false },
    // Added more users to demonstrate pagination
    { id: 6, name: "Sarah Connor", email: "sarah.c@student.edu", matric: "AUL/CMP/22/085", level: "300L", role: "Student", status: "Pending", avatarColor: "bg-red-100 text-red-600", selected: false },
    { id: 7, name: "John Wick", email: "john.w@student.edu", matric: "AUL/CMP/22/086", level: "400L", role: "Student", status: "Active", avatarColor: "bg-gray-100 text-gray-600", selected: false },
    { id: 8, name: "Bruce Wayne", email: "bruce.w@student.edu", matric: "AUL/CMP/22/087", level: "200L", role: "Class Rep", status: "Active", avatarColor: "bg-blue-100 text-blue-600", selected: false },
    { id: 9, name: "Clark Kent", email: "clark.k@student.edu", matric: "AUL/CMP/22/088", level: "400L", role: "Student", status: "Pending", avatarColor: "bg-blue-100 text-blue-600", selected: false },
    { id: 10, name: "Diana Prince", email: "diana.p@student.edu", matric: "AUL/CMP/22/089", level: "300L", role: "Student", status: "Active", avatarColor: "bg-pink-100 text-pink-600", selected: false },
    { id: 11, name: "Barry Allen", email: "barry.a@student.edu", matric: "AUL/CMP/22/090", level: "100L", role: "Student", status: "Active", avatarColor: "bg-red-100 text-red-600", selected: false },
    { id: 12, name: "Hal Jordan", email: "hal.j@student.edu", matric: "AUL/CMP/22/091", level: "200L", role: "Class Rep", status: "Pending", avatarColor: "bg-green-100 text-green-600", selected: false },
]

// log data for the new section
const recentLogs = [
    { id: 1, activity: 'Role Assignment: "Class Rep (400L)"', admin: 'Raphael F. (Gen Sec)', date: 'Oct 24, 10:30 AM', status: 'Pending Review', action: 'Review', statusColor: 'bg-[#FFEDD5] text-[#EA580C]', actionColor: 'text-[#16A34A]' },
    { id: 2, activity: 'New Student Verification Batch', admin: 'Admin User', date: 'Oct 24, 09:15 AM', status: 'Completed', action: 'Details', statusColor: 'bg-[#DCFCE7] text-[#16A34A]', actionColor: 'text-[#94A3B8]' },
    { id: 3, activity: 'Bulk CSV Import Failed', admin: 'Michael O. (PRO)', date: 'Oct 23, 04:45 PM', status: 'Pending Review', action: 'Approve', statusColor: 'bg-[#FFEDD5] text-[#EA580C]', actionColor: 'text-[#16A34A]' },
    { id: 4, activity: 'Student Info Update Request', admin: 'System (Auto-log)', date: 'Oct 23, 02:20 PM', status: 'New', action: 'Profile', statusColor: 'bg-[#DBEAFE] text-[#2563EB]', actionColor: 'text-[#94A3B8]' },
]
...
const UserManagement = () => {
    ...
    const toggleSelectAll = () => {
        ...
        const updatedUsers = users.map(user => {
            ...
            const isVisible = currentUsers.some(visibleUser => visibleUser.id === user.id)
            if (isVisible) {
    ...
    const isHeaderCheckboxChecked = currentUsers.length > 0 && currentUsers.every(user => user.selected)
    const selectedCount = users.filter(u => u.selected).length

    // Bulk Approver function
    const bulkApprover = () => {
        setUsers(users.map(user => user.selected ? { ...user, status: 'Active' } : user))
    }
            ...
            <div className=''>
                <div className='flex items-end justify-between mb-8'>
                    <div>
                        ...
                        <p className='text-[#64748B] text-[14px] md:text-[16px]'>Manage student profiles, verify accounts and assign reps</p>
                    </div>
                    <span className='hidden md:block text-[#64748B] text-xs'>Last Login <br /> Today 09:41 AM</span>
                </div>
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="bg-white rounded-3xl shadow border border-[#E5E7EB]">
                            ...
                            <div className="flex flex-col md:flex-row items-center gap-3 w-full md:w-auto text-[#64748B]">
                                <div className="relative w-full md:w-auto">
                                    <input 
                                        ...
                                        className="pl-10 pr-4 py-2 border border-[#E5E7EB] rounded-md font-medium text-sm focus:outline-none focus:ring-2 focus:ring-green-500 w-full md:w-[280px]"
                                    />
                                </div>
                                <button className="flex justify-center items-center gap-2 px-4 py-2 border border-[#E5E7EB] rounded-md text-sm font-medium w-full md:w-auto">
                                   <img src={Filter} alt="svg image of filter" className='w-3.5 h-3.5' /> Filter by Level
                                </button>
                            </div>
                                        ...
                                        <tr key={user.id} className={`border-b border-gray-50 hover:bg-gray-50 transition ${user.selected ? 'bg-green-50' : ''}`}>
                                            ...
                                            <td className="p-4">
                                                <span className={`px-3 py-1 rounded-full text-[12px] font-semibold ${
                                                    user.role === 'Class Rep' ? 'bg-[#F3E8FF] text-[#6B21A8]' : 'bg-[#F3F4F6] text-[#4B5563]'
                                                }`}>
                                                    {user.role}
                                                </span>
                                            </td>
                                            <td className="p-4">
                                                <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                                                    user.status === 'Active' ? 'bg-[#DCFCE7] text-[#166534]' :user.status === 'Rejected' ? 'bg-red-200 text-red-600' : 'bg-[#FEF9C3] text-[#854D0E]'
                                                }`}>
                                                    {user.status}
                                                </span>
                                            </td>
                                                ...
                                                <div className="flex items-center gap-3 text-gray-400">
                                                    {user.status === 'Pending' ? (
                                                        <>
                                                            ...
                                                            >
                                                                <img src={MarkDone} alt="Svg image" className='w-4 h-4' />
                                                            </button>
                                                            <button 
                                                                title="Reject"
                                                                ...
                                                                className='cursor-pointer'
                                                            >
                                                                <img src={Reject} alt="Svg image" className='w-4 h-4'  />
                                                            </button>
                                                        </>
                                                    ) : (
                                                        <>
                                                            <button title="View">
                                                                <img src={View} alt="Svg image" className='w-4 h-4' />
                                                            </button>
                                                            <button title="Edit">
                                                                <img src={Edit} alt="Svg image" className='w-4 h-4' />
                                                            </button>
                                                        </>
                                                    )}
                                                </div>
                        ...
                        <div className="p-4 flex flex-col md:flex-row justify-between items-center border-t border-[#E5E7EB] text-sm text-[#6B7280]">
                            <p className='font-medium text-[13px]'>Showing {indexOfFirstItem + 1} to {Math.min(indexOfLastItem, users.length)} of {users.length} students</p>
                            <div className="flex items-center gap-1 mt-2 md:mt-0">
                                ...
                                <button 
                                    ...
                                    className={`w-8 h-8 flex items-center justify-center border border-[#E5E7EB] rounded ${currentPage === 1 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-50 cursor-pointer'}`}
                                >
                                    &lt;
                                </button>
                                ...
                                <button 
                                    ...
                                    className={`w-8 h-8 flex items-center justify-center border border-gray-200 rounded ${currentPage === totalPages ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-50 cursor-pointer'}`}
                                >
                                    &gt;
                                </button>
                            </div>
                    ...
                    <div className="bg-white rounded-3xl shadow border border-[#E5E7EB] mb-10">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 px-6 pt-6 gap-4">
                            ...
                            <div className="flex gap-3 w-full sm:w-auto">
                                <button className="bg-brand-secondary border border-[#E2E8F0] text-[#64748B] px-4 py-2 rounded-lg text-sm font-medium flex-1 sm:flex-none text-center">Export Log</button>
                                <button className="bg-[#138601] text-white px-4 py-2 rounded-lg text-sm font-medium flex-1 sm:flex-none text-center">View All</button>
                            </div>
                        </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left min-w-200">
                                ...
                                <tbody className="text-[14px]">
                                    {recentLogs.map((log) => (
                                        <tr key={log.id} className="border-b border-[#F1F5F9] last:border-0 hover:bg-gray-50 transition">
