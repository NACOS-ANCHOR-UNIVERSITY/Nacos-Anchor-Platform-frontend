...
export default function Sidebar({ active, isOpen, setIsOpen }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 h-screen w-72 bg-white border-r border-gray-200 p-6 flex flex-col overflow-y-auto transition-transform duration-300 z-50 ${isOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0`}
      >
        <button
          onClick={() => setIsOpen(false)}
