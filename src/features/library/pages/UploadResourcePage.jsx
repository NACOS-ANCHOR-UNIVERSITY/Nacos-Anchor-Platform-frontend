...
export default function UploadResourcePage() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // 2. Prepare FormData (This handles the file binary)
      ...
      try {
        ...
        // If it's not JSON (like a 404 HTML page), manually throw the status text
    ...
    <div className="max-w-3xl mx-auto py-8 px-4">
      ...
      <div className="mb-6">
        <p className="text-sm text-gray-500 mb-2">
          Home / Resources / <span className="text-gray-900 font-medium">Upload</span>
        </p>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm">
          ...
          <div>
            ...
            <div className="flex border border-gray-200 rounded-lg p-1 bg-gray-50">
              {["100L", "200L", "300L", "400L"].map((lvl) => (
                <label
                  key={lvl}
                  className={`flex-1 text-center py-1.5 text-sm font-medium rounded-md cursor-pointer transition-all ${selectedLevel === lvl ? "bg-white shadow-sm text-green-700" : "text-gray-500 hover:text-gray-700"
                    }`}
                >
        ...
        <div className="mb-8">
          ...
          {!filePreview ? (
            <div className="border-2 border-dashed bg-gray-50 border-gray-300 rounded-lg p-8 text-center hover:bg-gray-100 transition-colors relative">
              {/* 👇 THE ACTUAL INPUT THAT OPENS THE FILE MANAGER */}
              <input
                type="file"
        ...
        <div className="flex justify-end gap-4 pt-4 border-t border-gray-100">
          ...
          <button
            ...
            className="px-6 py-2.5 text-sm font-medium text-white bg-green-700 hover:bg-green-800 rounded-lg flex items-center gap-2 disabled:opacity-50"
          >
