  ...
  return (
    <div className="mb-8">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between mb-4">
        <h2 className="text-xl font-bold text-gray-900 border-l-4 border-green-600 pl-3">Pending Fees</h2>
        <button className="text-[#138601] text-sm hover:text-gray-900 font-medium self-start sm:self-auto">View all →</button>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="relative bg-white border border-gray-200 rounded-xl p-6 flex flex-col">
          <span className="absolute top-4 right-4 bg-orange-100 text-orange-700 text-xs px-3 py-1 rounded-full font-medium">PENDING</span>
        ...
        <div className="relative bg-white border border-gray-200 rounded-xl p-6 flex flex-col">
          <span className="absolute top-4 right-4 bg-purple-100 text-purple-700 text-xs px-3 py-1 rounded-full font-medium">OPTIONAL</span>
          ...
          <div className="border-t border-gray-200 mt-6 pt-4 flex items-center justify-between gap-3">
            ...
            <button className="min-w-[5rem] border border-gray-300 hover:bg-gray-50 transition py-2.5 rounded-lg text-sm font-medium">Add to Cart</button>
          </div>
        </div>

        <div className="relative bg-white border border-gray-200 rounded-xl p-6 flex flex-col">
          <span className="absolute top-4 right-4 bg-green-100 text-green-700 text-xs px-3 py-1 rounded-full font-medium">NEW</span>
