  ...
  return (
    <>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6">
        <p className="text-xs text-gray-500 uppercase tracking-wide font-medium mb-2">Total Paid</p>
        <div className="flex items-center gap-3 mb-3">
          <h3 className="text-3xl font-bold text-gray-900">₦45,000</h3>
          <span className="bg-green-100 text-green-700 text-xs font-semibold px-2 py-1 rounded-full">Paid</span>
        </div>
        <p className="text-xs text-gray-400">Current Session 2023/2024</p>
      </div>

      <div className="bg-white border border-gray-200 rounded-xl p-6">
        <p className="text-xs text-gray-500 uppercase tracking-wide font-medium mb-2">Outstanding Dues</p>
        <h3 className="text-3xl font-bold text-orange-600 mb-3">₦7,000</h3>
        <p className="text-xs text-red-500 font-medium">Due by Nov 30, 2023</p>
      </div>
